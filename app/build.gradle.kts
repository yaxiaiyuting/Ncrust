...
android {
    ...
    defaultConfig {
        ...
        // **第十次按脚本定号**：三源（最近 5 个 tag / dist 48 个 APK 的 aapt2 badging /
        // 仓库当前 build.gradle）最大值都是 31 ⇒ 本版取 32。
        // v2.1.1 的 tag 已经推上去了，**不移动它**（本项目不重写已发布的历史，
        // 任务书也明确「tag 也不强推」）。真机反馈「手机号登录的 20276 图形验证码
        // 直接走不通」之后，验证码流程作为一个独立修复进 v2.1.2。
        versionCode = 32
        versionName = "2.1.2-gpl"
